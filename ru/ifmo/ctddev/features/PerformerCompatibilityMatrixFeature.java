...
public class PerformerCompatibilityMatrixFeature {
    ...
    public static Feature createFeature(String json) throws ParseException {
        ...
        JSONObject  jsonObj3 =  (JSONObject)  jsonObj2.get("performerOrder");
        ...
        return new Feature("PerformerOrderMatrix", rang, "Матрица совместимости.Данная связь (PerformerOrderRelations) используется для определения возможности исполнителя работать с определенным заказом (и всеми заявками, которые в него входят).");
