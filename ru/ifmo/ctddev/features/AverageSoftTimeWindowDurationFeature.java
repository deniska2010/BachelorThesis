...
public class AverageSoftTimeWindowDurationFeature {
    ...
    public static Feature createFeature(String json) throws ParseException {
        ...
        return new Feature("AverageSoftTimeWindowDuration", result / count, "Среднее мягкое(желаемое) временное окно. Продолжительность");
    }
}
