...
public class CountBreaksFeature {
    ...
    public static Feature createFeature(String json) throws ParseException {
        ...
        return new Feature("AverageNumberOfBreaks", result / count, "Среднее количество перерыров, в которое исполнители не доступны для выполнения заказов.");
    }
}
