...
public class AverageEventSoftTimeWindowFromFeature {
    ...
    public static Feature createFeature(String json) throws ParseException {
        ...
        return new Feature("AverageEventSoftTimeWindowFrom", result / count, "Среднее мягкое(желаемое) временное окно для события.Начало окна");
    }
}
