...
public class CapacityTimeWindowFeature {
    ...
    public static Feature createFeature(String json) throws ParseException {
        ...
        return new Feature("AverageCapacityTimeWindow", result / count, "Окна загрузки/разгрузки (CapacityWindow) для локаций определяют количество груза, которое локация способна отдать\\принять и содержат следующие параметры.Среднее временное окно по всем локациям,где есть эти окна.");
    }
