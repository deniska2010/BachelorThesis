...
public class PerformerShiftTimeWindowTo {
    ...
    public static Feature createFeature(String json) throws ParseException {
        ...
        return new Feature("AveragePerformerTimeWindowTo", result / count, "Среднее временное окно действия смены, в минутах.Конец окна.");
    }
}
