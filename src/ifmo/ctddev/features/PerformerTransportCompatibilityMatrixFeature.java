...
public class PerformerTransportCompatibilityMatrixFeature {
    public static Feature createFeature(String json) throws ParseException {
        ...
        JSONObject  jsonObj3 =  (JSONObject)  jsonObj2.get("performerTransport");
        ...
        return new Feature("PerformerTransportMatrix", rang, "Матрица совместимости.Данная связь (PerformerTransportRelations) используется для определения возможности исполнителя управлять определенным транспортным средством.");
