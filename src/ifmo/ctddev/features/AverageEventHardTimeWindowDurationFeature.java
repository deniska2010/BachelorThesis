...
public class AverageEventHardTimeWindowDurationFeature {
    public static Feature createFeature(String json) throws ParseException {
        ...
        return new Feature("AverageHardTimeWindowDuration", result / count, "Среднее жесткое временное окно для события. Продолжительность");
    }
}
