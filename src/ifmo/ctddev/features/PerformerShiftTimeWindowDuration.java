...
public class PerformerShiftTimeWindowDuration {
    ...
    public static Feature createFeature(String json) throws ParseException {
        ...
        return new Feature("AveragePerformerTimeWindowDuration", result / count, "Среднее временное окно действия смены, в минутах.Продолжительность окна.");
    }
}
