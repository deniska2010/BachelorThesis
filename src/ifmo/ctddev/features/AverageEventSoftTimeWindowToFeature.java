...
public class AverageEventSoftTimeWindowToFeature {
    ...
    public static Feature createFeature(String json) throws ParseException {
        ...
        return new Feature("AverageEventSoftTimeWindowTo", result / count, "Среднее мягкое(желаемое) временное окно для события.Конец окна.");
    }
}
